...
`runs/20260529-034208684_run-normalized-pics-part1-v1/SAMPLE_EXTRACT.md` より。IR内の最深階層（`document > chapter > paragraph > item > subitem`）から1件を抽出しています。paragraph本文は可読性を優先して空欄化し、祖先ノード自体は省略していません。
