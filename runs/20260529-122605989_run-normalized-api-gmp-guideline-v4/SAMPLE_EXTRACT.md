...
- source: `runs/20260529-122605989_run-normalized-api-gmp-guideline-v4/promotion_candidate/jp_pmda_api_gmp_guideline_20011102.regdoc_ir.yaml`
...
| 4 | `cha2.sec2_2.p2_22` | `paragraph` | `2.22` | `独立した品質部門の主要な責任は委任しないこと。その責任は文書化され、かつ、 以下の事項を含むこと。` |
