# RUN: 20260527-153334008_run-normalized-pics-annex11-v1
...
- `run/normalized-pics-annex11-v1`
...
.\.venv\Scripts\python.exe -m qai_text2ir.cli bundle `
  --input data/human-readable/pics/pe009-17_annex11_2023-08-25_en.txt `
  --out-dir runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate `
...
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/pics_pe00917_annex11_20230825.regdoc_ir.yaml`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/pics_pe00917_annex11_20230825.parser_profile.yaml`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/pics_pe00917_annex11_20230825.regdoc_profile.yaml`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/pics_pe00917_annex11_20230825.meta.yaml`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/manifest.yaml`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/GOAL_CHECK_RESULT.md`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate/goal_check_result.json`
- `runs/20260527-153334008_run-normalized-pics-annex11-v1/SAMPLE_EXTRACT.md`
...
- PyYAML: `6.0.3`
- typer: `0.24.0`
- base commit: `ea8aa17f2b43c158be21286e4f7ad6da652b525c`

## 検証

```powershell
.\.venv\Scripts\python.exe -m qai_text2ir.goal_check `
  --bundle-dir runs/20260527-153334008_run-normalized-pics-annex11-v1/promotion_candidate `
  --doc-id pics_pe00917_annex11_20230825 `
  --mode promotion `
  --format markdown
```
