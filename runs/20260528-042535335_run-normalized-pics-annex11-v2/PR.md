...
- `runs/20260528-042535335_run-normalized-pics-annex11-v2/promotion_candidate/` に4ファイルbundleとmanifestを追加
...
- `ann11.sec14.kind_raw` が原文マーカーの `14.` として保持されていること
...
<!-- PR_BODY_FILE: runs/20260528-042535335_run-normalized-pics-annex11-v2/PR.md -->
