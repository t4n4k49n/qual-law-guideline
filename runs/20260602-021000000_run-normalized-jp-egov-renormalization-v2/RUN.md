...
- run_id: `20260602-021000000_run-normalized-jp-egov-renormalization-v2`
- branch: `run/normalized-jp-egov-renormalization-v2`
- scope: 旧e-Gov正規化の現行基準への再正規化
- promotion candidate: `runs/20260602-021000000_run-normalized-jp-egov-renormalization-v2/promotion_candidate/`
...
uv run python -m qai_xml2ir.cli bundle `
  ...
  --out-dir runs/20260602-021000000_run-normalized-jp-egov-renormalization-v2/promotion_candidate/<doc_id> `
  --doc-id <doc_id> `
...
承認後、`runs/20260602-021000000_run-normalized-jp-egov-renormalization-v2/promotion_candidate/` の各doc_id配下から `data/normalized/<doc_id>/` へ複写する子PRを別途作成する。
