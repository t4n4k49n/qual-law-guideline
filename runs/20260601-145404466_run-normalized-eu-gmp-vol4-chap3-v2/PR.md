...
EU GMP Vol.4 Chapter 3（Premises and Equipment）を、DQのGMPチェックシートで参照できる正規化候補として追加します。#248でmainに反映済みのChap3専用profileを使い、施設・設備に関する要求事項を段落単位で選択・祖先文脈表示できる状態にします。
...
承認後、子PRで `runs/20260601-145404466_run-normalized-eu-gmp-vol4-chap3-v2/promotion_candidate/` から `data/normalized/eu_gmp_vol4_chap3_20150123/` へ複写します。

<!-- PR_BODY_FILE: runs/20260601-145404466_run-normalized-eu-gmp-vol4-chap3-v2/PR.md -->
