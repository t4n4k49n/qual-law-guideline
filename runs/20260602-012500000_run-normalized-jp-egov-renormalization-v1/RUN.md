# 旧e-Gov正規化 再正規化RUN v1

- run_id: `20260602-012500000_run-normalized-jp-egov-renormalization-v1`
- branch: `run/normalized-jp-egov-renormalization-v1`
- scope: 旧e-Gov正規化の現行基準への再正規化
- promotion candidate: `runs/20260602-012500000_run-normalized-jp-egov-renormalization-v1/promotion_candidate/`
- source preparation run: `runs/20260602-005222271_egov-renormalization-prep/`

## 前提確認

- `main` は PR `#259` merge後の `origin/main` へ同期済み
...
uv run python -m qai_xml2ir.cli bundle `
  ...
  --out-dir runs/20260602-012500000_run-normalized-jp-egov-renormalization-v1/promotion_candidate/<doc_id> `
  --doc-id <doc_id> `
...
- `uv run python tools/check_ir_structure.py runs/20260602-012500000_run-normalized-jp-egov-renormalization-v1/promotion_candidate`
...
承認後、`runs/20260602-012500000_run-normalized-jp-egov-renormalization-v1/promotion_candidate/` の各doc_id配下から `data/normalized/<doc_id>/` へ複写する子PRを別途作成する。
