# RUN: 20260218-101740760_feat-pics-annex2a-v1-strict

- run_id: `20260218-101740760_feat-pics-annex2a-v1-strict`
...
- `src/qai_text2ir/text_parser.py`
  ...
  - structural heading continuation を `kinds` 指定対象のみに限定。
...
## 実行
- `python -m pytest -q tests/test_slice_pics_annex.py tests/test_pics_annex2a_preformatted.py`
- `python -m pytest -q tests/test_who_lbm_heading_merge.py tests/test_text2ir_normalization.py tests/test_slice_pics_annex.py tests/test_pics_annex2a_preformatted.py`
- `python -m qai_text2ir.cli --input data/human-readable/pics/pe009-17_annex2a_2023-08-25_en.txt --out-dir out/20260218-101740760_feat-pics-annex2a-v1-strict --doc-id pics_pe00917_annex2a_20230825 --title "PIC/S GMP Guide (PE 009-17) Annex 2A ATMP (25 August 2023)" --short-title "PIC/S Annex 2A (ATMP)" --jurisdiction INTL --family PICS --language en --doc-type guideline --source-url "https://picscheme.org/docview/8881" --source-format pdf --retrieved-at "2026-02-18" --pics-doc-id "PE 009-17 (Annexes)" --parser-profile src/qai_text2ir/profiles/pics_annex2a_default_v1.yaml --qualitycheck --strict --emit-only all`
...
## 生成物
- `out/20260218-101740760_feat-pics-annex2a-v1-strict/pics_pe00917_annex2a_20230825.regdoc_ir.yaml`
- `out/20260218-101740760_feat-pics-annex2a-v1-strict/pics_pe00917_annex2a_20230825.parser_profile.yaml`
- `out/20260218-101740760_feat-pics-annex2a-v1-strict/pics_pe00917_annex2a_20230825.regdoc_profile.yaml`
- `out/20260218-101740760_feat-pics-annex2a-v1-strict/pics_pe00917_annex2a_20230825.meta.yaml`
- `out/20260218-101740760_feat-pics-annex2a-v1-strict/manifest.yaml`
- `runs/20260218-101740760_feat-pics-annex2a-v1-strict/RUN.md`
