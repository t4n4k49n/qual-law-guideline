...
def test_strip_inline_page_tokens_and_header(tmp_path: Path) -> None:
    ...
    parser_profile = _load_profile("src/qai_text2ir/profiles/who_lbm_3rd_default_v1.yaml")
...
def test_profile_loader_defaults_to_who_lbm_v1() -> None:
    profile = load_parser_profile(family="WHO_LBM")
    assert profile["id"] == "who_lbm_3rd_default_v1"
