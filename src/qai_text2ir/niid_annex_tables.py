...
TABLE_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "別表4": {
        ...
        "columns": ["category", "criterion", "type1_bsl4", "type2_bsl3", "type2_bsl2", "type3_bsl3", "type3_bsl2", "type4_bsl3", "type4_bsl2"],
        "source_format": "fixed_width_matrix",
    },
    "別表5": {
        "start_contains": "対象病原体等ＢＳＬ",
...
DISPLAY_COLUMNS_BY_NUM: Dict[str, List[str]] = {
    ...
    "別表4": ["区分", "基準", "1種 BSL4", "2種 BSL3", "2種 BSL2", "3種 BSL3", "3種 BSL2", "4種 BSL3", "4種 BSL2"],
    "別表5": ["区分", "基準", "1種 BSL4", "2種 BSL3", "2種 BSL2", "3種 BSL3", "3種 BSL2", "4種 BSL3", "4種 BSL2"],
